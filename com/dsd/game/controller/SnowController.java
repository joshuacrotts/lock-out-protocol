...
public class SnowController implements Renderable, Updatable {
    ...
    // Serves as a debugging feature (if enabled, it ignores the API call and automactically enables snow).
...
//================================= GETTERS ===================================
    private double getRandomSpeed(int _speedFactor) {
        // Returns a random speed between [0 - speedFactor]. Determines how fast each snow drop will fall.
