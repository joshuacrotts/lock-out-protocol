...
public class SuperShotgun extends Gun {
    ...
    public SuperShotgun(Game _game, Player _player, StandardCollisionHandler _sch) {
        ...
        super.loadCasingImages(SuperShotgun.CASING_IMAGES);
    }
    ...
    public void loadAssets(Player _player) {
        ...
        StandardAnimatorController walkingAnimation = new StandardAnimatorController(
                new StandardAnimation(_player, Utilities.loadFrames("src/resources/img/player/player_" + _player.getPlayerSex() + "/player_walk_supershotgun/", WALKING_FRAMES), WALKING_FPS));
        StandardAnimatorController shootingAnimation = new StandardAnimatorController(
                new StandardAnimation(_player, Utilities.loadFrames("src/resources/img/player/player_" + _player.getPlayerSex() + "/player_shoot_supershotgun/", SHOOTING_FRAMES), SHOOT_GUN_FPS));
