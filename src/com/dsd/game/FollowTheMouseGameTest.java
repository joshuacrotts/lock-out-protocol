...
public class FollowTheMouseGameTest extends StandardGame {
    ...
    private final RainController rainController; //Toggles rain if it is raining in the city the user enters
    ...
    public FollowTheMouseGameTest(String weather) {
        ...
        this.rainController = new RainController(this, this.sc, weather);
        ...
        //  Defaults the game's state to running
